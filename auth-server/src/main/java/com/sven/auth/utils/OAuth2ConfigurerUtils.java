...
public class OAuth2ConfigurerUtils {
    ...
    public RegisteredClientRepository getRegisteredClientRepository(HttpSecurity httpSecurity) {
    ...
    private JwtGenerator getJwtGenerator(HttpSecurity httpSecurity) {
    ...
    private JwtEncoder getJwtEncoder(HttpSecurity httpSecurity) {
    ...
    @SuppressWarnings("unchecked")
    private JWKSource<SecurityContext> getJwkSource(HttpSecurity httpSecurity) {
